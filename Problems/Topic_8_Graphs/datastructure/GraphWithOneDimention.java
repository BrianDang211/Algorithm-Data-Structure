...
public class GraphWithOneDimention<VT> implements Graph<VT> {

      public GraphWithOneDimention() {
            this.setGraphData();
      }
      ...
      public void addVertice(VT fromVertice, VT toVertice) {
            ...
            throw new UnsupportedOperationException("Unimplemented method 'addVertice'");
      }
      ...
      public void setGraphData() {
            // TODO Auto-generated method stub
            throw new UnsupportedOperationException("Unimplemented method 'setGraphData'");
      }
